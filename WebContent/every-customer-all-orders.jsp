						...
						<table id="table" id="table" class="table table-bordered">
							...
							<tbody>
								<tr>
									...
									<td><%=totalMedicine.getDouble("medicine_mrp_price")%>&nbsp;Rs.</td>
									<td><%=totalMedicine.getDouble("medicine_discount_price")%>&nbsp;Rs.</td>
									<td><%=totalMedicine.getDouble("medicine_total_price")%>&nbsp;Rs.</td>
